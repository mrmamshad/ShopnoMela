                ...
                <TableBody>
                    ...
                    <TableRow key={order.id}>
                        ...
                        <TableCell className="flex gap-2">
                            ...
                            <Button size="sm" variant="success" className="bg-green-500 hover:bg-green-600"
                            ...
                            {/* send for shipping */}
                            <Button size="sm" variant={order.status === "Shipped" ? "success" : "outline" }
                                disabled={order.status === "Shipped"} onClick={()=> handleShipOrder(order.id)}
                                >
                                {order.status === "Shipped" ? "Shipped" : "Send for Shipping"}
                            </Button>
                            <Button size="sm" variant={order.status === "Delivered" ? "success" : "outline" }
                                disabled={order.status === "Delivered"} onClick={()=> playsound()}
                                >
